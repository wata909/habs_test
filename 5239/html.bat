...
$html = Get-content .\rapid544000.html | % { $_ -replace "rapid544000.geojson", "rapid523926.geojson" } | % { $_ -replace "http://wata909.github.io/habs_test/geojson/", "http://wata909.github.io/habs_test/5239/geojson/" } 
$html | Out-File rapid523926.html -Encoding UTF8
