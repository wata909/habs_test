...
$html = Get-content .\rapid544000.html | % { $_ -replace "rapid523926.geojson", "rapid523927.geojson" } | % { $_ -replace "http://wata909.github.io/habs_test/geojson/", "http://wata909.github.io/habs_test/5239/geojson/" } 
